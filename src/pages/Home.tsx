...
export const Home: React.FC = () => {
  ...
  const marqueePartners = partners.filter(p => 
    ['Intel', 'Dell', 'Canon', 'Microsoft', 'Amazon Web Services', 'Cisco', 'IBM', 'HP', 'Oracle', 'Red Hat', 'SAP', 'VMware', 'Apple'].includes(p.name)
  );
  ...
  return (
    <div className="relative">
      ...
      {/* SECTION 1: HERO */}
      <section className="relative min-h-screen flex items-start lg:items-center justify-center overflow-hidden pt-28 pb-20">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full relative z-10 grid grid-cols-1 lg:grid-cols-12 gap-12 items-center mt-20 lg:mt-24">
          ...
          <div className="lg:col-span-5 relative w-full h-[320px] sm:h-[400px] lg:h-[450px] flex items-center justify-center mt-8 lg:mt-0">
            <ScrollReveal direction="fade" delay={300} className="w-full h-full">
              ...
              <div className="absolute top-[40%] left-[2%] sm:left-[0%] lg:left-[-10%]">
